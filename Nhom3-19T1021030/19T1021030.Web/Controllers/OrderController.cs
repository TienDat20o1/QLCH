...
namespace _19T1021030.Web.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public ActionResult Shipping(int id = 0, int ShiperID = 0)
        {
            ...
            {
                ViewBag.Title = ShiperID == 0 ? "Bổ sung mặt hàng" : "Cập nhật mặt hàng";
                ViewBag.ShiperID = ShiperID;
                return View();
            }
            if (ShiperID > 0)
            {
                OrderService.ShipOrder(id, ShiperID);
            }
            return RedirectToAction($"Details/{id}");
        }
        /// <summary>
